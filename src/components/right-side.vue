<template>
  <div class="right_side">
    ...
    <div class="form-group">
      ...
      <input type="text" id="style-preference" name="style-preference">
    </div>
    <div class="checkbox-group">
      <div class="column">
        <input type="checkbox" id="women" name="women">
        <label for="women">Women</label><br>
        <input type="checkbox" id="plus-size" name="plus-size">
      ...
      <div class="column">
        ...
        <input type="checkbox" id="pets-supplies" name="pets-supplies">
        <label for="pets-supplies">Pets Supplies</label>
      </div>
    </div>
    <button class="register-btn">REGISTER</button>
    <p class="small-text">FIRST ORDER✈FREE SHIPPING & ¥300 OFF</p>
    <p class="small-text">Why Register?</p>
  </div>
</template>
